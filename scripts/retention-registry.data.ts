...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		writerCitations: [
			'src/gate-evidence.ts:1176 transitionTaskWorkflowEvidence / :1291 recordGateEvidence / :1349 recordAgentDispatch — locked read-modify-write, atomic write',
			'src/council/council-evidence-writer.ts:96 writeCouncilEvidence — gates.council section under withTaskEvidenceLock',
		],
		readerCitations: [
			'src/gate-evidence.ts:1393 readTaskEvidence — FULL-FILE fail-open, async; :1469 readTaskEvidenceRaw — strict, sync',
