...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		writerCitations: ['src/background/pr-feedback-event-queue.ts:444 writeQueueRecord — atomic temp+fsync+Windows-retry rename (enqueue/claim)'],
		readerCitations: ['src/background/pr-feedback-event-queue.ts:712 readPrFeedbackMonitorQueueFromDisk — bounded ≤512 KiB with identity verification, async'],
