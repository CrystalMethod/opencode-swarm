...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		writerCitations: [
			'src/gate-evidence.ts:1170 transitionTaskWorkflowEvidence / :1285 recordGateEvidence / :1343 recordAgentDispatch — locked read-modify-write, atomic write',
			'src/council/council-evidence-writer.ts:96 writeCouncilEvidence — gates.council section under withTaskEvidenceLock',
		],
		readerCitations: [
			'src/gate-evidence.ts:1387 readTaskEvidence — FULL-FILE fail-open, async; :1463 readTaskEvidenceRaw — strict, sync',
