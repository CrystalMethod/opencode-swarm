...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		writerCitations: ['src/test-impact/analyzer.ts:988 saveImpactMap — atomic cache write (rebuildable derived cache)'],
		readerCitations: ['src/test-impact/analyzer.ts:981 loadImpactMap — map-only API; authoritative identity validation/rebuild, with unverified skipRebuild envelope reads'],
