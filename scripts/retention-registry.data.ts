...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		writerCitations: ['src/test-impact/analyzer.ts:1108 saveImpactMap — atomic cache write (rebuildable derived cache)'],
		readerCitations: ['src/test-impact/analyzer.ts:1101 loadImpactMap — map-only API; authoritative identity validation/rebuild, with unverified skipRebuild envelope reads'],
